...
let energyDrink=( userPreference || `Regular`);
...
let trackCans= ( cansLeft < 5 ? `Time to restock!` : 'We\'re stocked');
console.log(trackCans)
...
let bpmRate = heartRate < 100 ?`Boost needed!` : 'Energy levels are high!';
console.log(bpmRate)
...
let tempCelsius= (currentTemp <= 5 ?`Chilled to perfection!` : 'Needs a cooler!');
...
let currentHour = 22;
let Time= (currentHour >= 7 && currentHour <= 24 ? 'Unleash the beast!' : 'Better stick to water')
console.log(Time)
